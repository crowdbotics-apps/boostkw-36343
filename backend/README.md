...
## Project Structure
    ...
    ├── sunrun_solar_projec_36343  # Django project configurations
...
1. Clone this repo and `cd sunrun_solar_projec_36343`
...
2. Clone this repo and `cd sunrun_solar_projec_36343`
