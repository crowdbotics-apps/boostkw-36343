    ...
    <ScrollView style={[Layout.fill]} contentContainerStyle={[Layout.column]}>
      ...
      >
        ...
        >
          ...
          <View
            style={[Layout.row, Gutters.smallHPadding, Gutters.regularVMargin]}
          >
            <Text
              style={[Fonts.textTerms, { fontWeight: '600', fontSize: 14 }]}
            >
          ...
          <View
            style={[Layout.row, Gutters.smallHPadding, Gutters.smallVMargin]}
          >
            <Text style={[Fonts.textTerms]}>
          ...
          <View
            style={[Layout.row, Gutters.smallHPadding, Gutters.smallTMargin]}
          >
            <Text
              style={[Fonts.textTerms, { fontWeight: '600', fontSize: 14 }]}
            >
          ...
          <View
            style={[Layout.col, Gutters.smallHPadding, Gutters.smallVMargin]}
          >
            <Text style={[Fonts.textTerms, Gutters.smallBMargin]}>
              For the purposes of these Terms and Conditions:
            </Text>
            <Text style={[Fonts.textTerms, Gutters.smallBMargin]}>
              * Application means the software program provided by the Company
              downloaded by You on any electronic device, named tracknapp
            </Text>
            <Text
              style={[Fonts.textTerms, Gutters.smallBMargin]}
            >{`* Application Store means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.`}</Text>
            <Text
              style={[Fonts.textTerms, Gutters.smallBMargin]}
            >{`* Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.`}</Text>
            <Text style={[Fonts.textTerms, Gutters.smallBMargin]}>
            ...
            <Text
              style={[Fonts.textTerms, Gutters.smallBMargin]}
            >{`* Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Mainstream Energy Corporation dba SnapNrack, 225 Bush Street, Suite 1400, San Francisco, CA 94101.`}</Text>
            <Text style={[Fonts.textTerms, Gutters.smallBMargin]}>
            ...
            <Text
              style={[Fonts.textTerms, Gutters.smallBMargin]}
            >{`* Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.`}</Text>
            <Text
              style={[Fonts.textTerms, Gutters.smallBMargin]}
            >{`* Third-party Social Media Service means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.`}</Text>
            <Text
              style={[Fonts.textTerms, Gutters.smallBMargin]}
            >{`* Website refers to SnapNrack, accessible from <https://snapnrack.com/>`}</Text>
            <Text style={[Fonts.textTerms, Gutters.smallBMargin]}>
          ...
          >
            <Text
              style={[Fonts.textTerms, { fontWeight: '600', fontSize: 12 }]}
            >
              Subscription period
            </Text>
          </View>
          ...
          >
            <Text style={[Fonts.textTerms]}>
              ...
              telephone number, and a valid payment method information. Should
          ...
          >
            <Text style={[Fonts.textTerms]}>
              ...
              a Free Trial for a limited period of time. You may be required to
              enter Your billing information in order to sign up for the Free
              Trial. If You do enter Your billing information when signing up
              for a Free Trial, You will not be charged by the Company until the
              Free Trial has expired. On the last day of the Free Trial period,
              unless You cancelled Your Subscription, You will be automatically
              charged the applicable Subscription fees for the type of
              Subscription You have selected. At any time and without notice,
              the Company reserves the right to (i) modify the terms and
          ...
          >
            <Text style={[Fonts.textTerms]}>
              ...
              Third-Party Social Media Service. You agree not to disclose Your
          ...
          >
            <Text style={[Fonts.textTerms]}>
              ...
              rights to any Content You submit, post or display on or through
              ...
              Your Content subject to these Terms. You represent and warrant
              that: (i) the Content is Yours (You own it) or You have the right
              to use it and grant Us the rights and license as provided in these
              Terms, and (ii) the posting of Your Content on or through the
