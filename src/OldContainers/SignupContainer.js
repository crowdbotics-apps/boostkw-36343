      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          ...
          {nextPage ? (
            ...
            >
              <Title text={'Set up account'} onPressBack={onClickBack} />
            </View>
          ) : (
            <View
              style={[
            ...
            >
              ...
              >
                ...
                <Text style={[Fonts.titleBold, Fonts.textCenter]}>Sign Up</Text>
                <View />
              </View>
            </View>
          )}
          ...
          {!nextPage && (
            ...
            >
              ...
              >
                <Text style={[Fonts.textButtonSmall, Fonts.textCenter]}>
                  By using BOOSTKW you agree to our{' '}
                  <Text
                    style={{ color: '#338AF4' }}
